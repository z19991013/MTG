...
def false_graph_filtering(distance_thresh):
    root_dir = 'G:/TEA-graph-master/TEA-graph-master/Sample_data_for_demo/Graph_test/TCGA/KIRC/superpatch/'
        ...
        for sample_name, supernode_path, pt in zip(sample_files, supernode_files, pt_files):
            ...
            if not os.path.isfile(os.path.join(root_dir, sample_name + "_" + str(different_value) + "_graph_torch_" + str(
                ...
                if 'pass' not in pt:
                    ...
                    location = os.path.join('G:/TEA-graph-master/TEA-graph-master/Sample_data_for_demo/Graph_test/TCGA/KIRC/original/', sample_name + '_node_location_list.csv')
                    # print(pt)
                    ...
                    if os.path.isfile(supernode_path):
                        ...
                        torch.save(new_graph, os.path.join(root_dir, sample_name + "_" + str(
                            ...
                            distance_thresh) + "_artifact_sophis_final.pt"))
                        #torch.save(new_graph, os.path.join('E:/TEA-graph-master/TEA-graph-master/Sample_data_for_demo/Graphdata/KIRC/', sample_name + "_" + str(different_value) +"_graph_torch_" + str(distance_thresh) + "_artifact_sophis_final.pt"))
            pbar.update()
